...
using OnlineShop.Api_ComponentOrServiceTest.ClassFixture;
...
namespace OnlineShop.Api_ComponentOrServiceTest.OnlineShopApi.Controllers
{
    public class CategoryControllerComponentTest
    {

        public readonly DependenceProjectFixture fixture;
        public CategoryControllerComponentTest()
        {
            fixture = new DependenceProjectFixture(
